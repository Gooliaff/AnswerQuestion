...
class QuestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val button_One: Button = findViewById(R.id.button_a)
        val button_Two: Button = findViewById(R.id.button_b)
        val button_Tree: Button = findViewById(R.id.button_c)
    ...
    fun updateQuestion() {
        questionNo += 1
        val textQuest: TextView = findViewById(R.id.text_answer)
        if (questionNo <= 9) {
        ...
        val result_Score: TextView = findViewById(R.id.button_result)
